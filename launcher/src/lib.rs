...
pub struct Args {
    ...
    pub cuda_graphs: Option<Vec<usize>>,
    ...
    /// Used to override the location if you want to provide a mounted disk for instance
    #[clap(long, env)]
    pub weights_cache_override: Option<String>,
    ...
    #[clap(long, env)]
    pub watermark_gamma: Option<f32>,
    #[clap(long, env)]
    pub watermark_delta: Option<f32>,
    ...
    #[clap(long, env)]
    pub disable_grammar_support: bool,
